<template>
  <a-form layout="horizontal">
    ...
    <a-form-item label="循环变量"
                 :label-col="formItemLayout.labelCol"
                 :wrapper-col="formItemLayout.wrapperCol">
      <a-input placeholder="请输入循环变量"
               :value="currentSelect.loopVarName"
               @change="loopVarNameChange" />
    </a-form-item>
  </a-form>
</template>
<script>
export default {
  ...
  methods: {
    ...
    loopVarNameChange (e) {
      this.nodeAttrChange({ attr: 'loopVarName', payload: e.target.value })
    }
  }
}
</script>
