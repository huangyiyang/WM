...
/*for WiseMotion sec add*/
function _WiseMotionEnCode (key, iv, str2encode) {
  return CryptoJS.AES.encrypt(str2encode, key, {iv: iv, mode: CryptoJS.mode.CBC, padding:CryptoJS.pad.ZeroPadding});
}
...
let WiseMotionSecEnCode = curry(_WiseMotionEnCode)
export default WiseMotionSecEnCode(CryptoJS.enc.Utf8.parse('!@#$%^&*87654321'), CryptoJS.enc.Utf8.parse('!@#$%^&*87654321'))
